 ...
 **/
@Component
public class QGGDGYCPXSLEightTDataThread extends Thread {
    public static Integer getPageNum() {
        return pageNum;
    }

    public static void setPageNum(Integer pageNum) {
        QGGDGYCPXSLEightTDataThread.pageNum = pageNum;
    }
    ...
    public static void setMaxPage(Integer maxPage) {
        QGGDGYCPXSLEightTDataThread.maxPage = maxPage;
    }
    ...
    public QGGDGYCPXSLEightTDataThread(IppMapper ippMapper, MyMapper myMapper) {
    ...
    public void run(){
        while (true) {
            ...
            List<HashMap<String, String>> list = myMapper.selectQGGDQGYCPXSLData18();
            //超过页数时跳出

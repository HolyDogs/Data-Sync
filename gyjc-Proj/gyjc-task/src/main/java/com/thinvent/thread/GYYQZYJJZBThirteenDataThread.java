 ...
 **/
@Component
public class GYYQZYJJZBThirteenDataThread extends Thread {
    public static Integer getPageNum() {
        return pageNum;
    }

    public static void setPageNum(Integer pageNum) {
        GYYQZYJJZBThirteenDataThread.pageNum = pageNum;
    }
    ...
    public static void setMaxPage(Integer maxPage) {
        GYYQZYJJZBThirteenDataThread.maxPage = maxPage;
    }
    ...
    public GYYQZYJJZBThirteenDataThread(IppMapper ippMapper, MyMapper myMapper) {
    ...
    public void run(){
        while (true) {
            ...
            List<HashMap<String, String>> list = myMapper.selectGYYQZYJJZBData13();
            //超过页数时跳出

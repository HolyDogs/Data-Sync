 ...
 **/
@Component
public class ZDQYCXDataThread extends Thread {
    public static Integer getPageNum() {
        return pageNum;
    }

    public static void setPageNum(Integer pageNum) {
        ZDQYCXDataThread.pageNum = pageNum;
    }
    ...
    public static void setMaxPage(Integer maxPage) {
        ZDQYCXDataThread.maxPage = maxPage;
    }
    ...
    public ZDQYCXDataThread(IppMapper ippMapper, MyMapper myMapper) {
    ...
    public void run(){
        while (true) {
            ...
            List<HashMap<String, String>> list = myMapper.selectZDQYCXData();
            //超过页数时跳出

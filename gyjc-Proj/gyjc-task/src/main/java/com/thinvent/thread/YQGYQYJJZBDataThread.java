 ...
 * @author xufeng
 * @version 1.0
 * @date 2020/6/30 下午 10:50
 **/
@Component
public class YQGYQYJJZBDataThread extends Thread {
    public static Integer getPageNum() {
        return pageNum;
    }

    public static void setPageNum(Integer pageNum) {
        YQGYQYJJZBDataThread.pageNum = pageNum;
    }
    ...
    public static void setMaxPage(Integer maxPage) {
        YQGYQYJJZBDataThread.maxPage = maxPage;
    }
    ...
    public YQGYQYJJZBDataThread(IppMapper ippMapper, MyMapper myMapper) {
    ...
    public void run(){
        while (true) {
            ...
            List<HashMap<String, String>> list = myMapper.selectYQGYQYJJZBData();
            //超过页数时跳出

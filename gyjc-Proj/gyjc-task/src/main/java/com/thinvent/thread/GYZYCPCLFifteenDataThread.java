 ...
 **/
@Component
public class GYZYCPCLFifteenDataThread extends Thread {
    public static Integer getPageNum() {
        return pageNum;
    }

    public static void setPageNum(Integer pageNum) {
        GYZYCPCLFifteenDataThread.pageNum = pageNum;
    }
    ...
    public static void setMaxPage(Integer maxPage) {
        GYZYCPCLFifteenDataThread.maxPage = maxPage;
    }
    ...
    public GYZYCPCLFifteenDataThread(IppMapper ippMapper, MyMapper myMapper) {
    ...
    public void run(){
        while (true) {
            ...
            List<HashMap<String, String>> list = myMapper.selectGYZYCPCLData15();
            //超过页数时跳出

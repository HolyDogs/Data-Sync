...
//月度同比计算
@Service
public class MonthTBCountImpl implements Dimention{
    ...
    public List<HashMap> getResult(String tableName, String zbmc, String dataSource
        ...
        List<HashMap> mapList = zsTjTableMapper.selectBaseTjData(tjTableName, zbkey, "月度值");
        return dimentionUtils.calcuMonthTB(mapList,tjTableName,zbkey,"YDTB");
    }
